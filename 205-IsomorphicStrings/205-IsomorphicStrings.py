# Last updated: 3/28/2025, 3:26:00 PM
class Solution:
    def isIsomorphic(self, s: str, t: str) -> bool:
        ...
        for i in range(len(s)):
            ...
            if char_t in t_s:
                ...
                t_s[char_t] = char_s
        # Reach the end of the loop without finding any mapping conflicts, it means the strings are isomorphic, and we return True.
        return True